...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  (function () {
    ...
    (function () {
      // If we use the theme currency converter, we have to do that in JavaScript. If we are using the native multi
      // currency of Shopify, everything is handled through the official form
      if (window.theme.currencyConversionEnabled) {
